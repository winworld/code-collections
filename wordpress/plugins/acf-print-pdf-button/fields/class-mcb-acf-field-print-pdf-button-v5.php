...
if( !class_exists('mcb_acf_field_print_pdf_button') ) :


class mcb_acf_field_print_pdf_button extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('Print PDF Button', 'TEXTDOMAIN');
		...
		*  var message = acf._e('print_pdf_button', 'error');
		*/
	...
	*/
	...
	function render_field( $field ) {
		...
		*/
		...
		echo "<a href='" . add_query_arg(array('output' => 'pdf'), $_SERVER['REQUEST_URI']) . "' id='reset' class='button button-primary'>Download PDF</a>";
...
// initialize
new mcb_acf_field_print_pdf_button( $this->settings );
